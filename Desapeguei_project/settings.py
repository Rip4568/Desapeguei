...
DEBUG = str(os.getenv('DEBUG',default="False")) == 'x'
...
#o whitenoise ira prover os arquivos estaticos
STATICFILES_STORAGE = "whitenoise.storage.CompressedStaticFilesStorage"
#o cloudinary ira prover os arquivos de media
